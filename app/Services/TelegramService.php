...
class TelegramService
{
    ...
    public function sendMessage($chatId, $message, $keyboard = null)
    {
        ...
        if ($response->successful()) {
            ...
            Log::error("Gagal mengirim pesan ke Telegram. Respons: " . $response->body());
        } elseif ($response->clientError()) {
            Log::error("Client error saat mengirim pesan ke Telegram. Status Code: " . $response->status());
        } elseif ($response->serverError()) {
            Log::error("Server error saat mengirim pesan ke Telegram. Status Code: " . $response->status());
        }
    }
}
