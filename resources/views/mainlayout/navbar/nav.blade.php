<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    @if (Auth::user()->role == 'pemilik')
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'teknisi.index' ? 'active' : '' }}"
                    href="{{ route('teknisi.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-tv-2 text-sm opacity-10" style="background: rgba(94,114,228,1);"></i>
                    </div>
                    <span class="nav-link-text ms-1">Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'tickets.viewEscalation' ? 'active' : '' }}"
                    href="{{ route('tickets.viewEscalation') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'teknisi.viewasigne' ? 'active' : '' }}"
                    href="{{ route('teknisi.viewasigne') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-calendar-grid-58 text-sm opacity-10"
                            style="background: rgba(245,158,11,1);"></i>
                    </div>
                    <span class="nav-link-text ms-1">Assigned Ticket</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'teknisi.closeticket' ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'teknisi.ListTicket' ? 'active' : '' }}"
                    href="{{ route('teknisi.ListTicket') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'pengumuman.index' ? 'active' : '' }}"
    ...
    @elseif (Auth::user()->role == 'admin')
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'admin.manageuser' ? 'active' : '' }}"
    ...
    @elseif (Auth::user()->role == 'penyewa')
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'customer.tickets' ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'customer.viewprocess' ? 'active' : '' }}"
                    href="{{ route('customer.viewprocess') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'customer.profile' ? 'active' : '' }}"
