                ...
                <table class="table align-items-center mb-0" id="escalationTable">
                    ...
                    <tbody>
                        @foreach($teknisi_data_ticket as $teknisidataticket)
                                        <tr class="align-middle text-sm border border-light" data-created-at="{{ $dataticket->created_at->timestamp }}" data-jenis-pengaduan="{{ $dataticket->Jenis_Pengaduan }}" data-status="{{ $dataticket->status }}">
                                            <td class="align-middle text-sm border border-light" data-subject="{{ $dataticket->subject }}">
...
<script>
    $(document).ready(function () {
        ...
        function sortTableByDate(direction) {
            var rows = $('#escalationTable tbody tr').get();
            ...
            $.each(rows, function(index, row) {$('#escalationTable tbody').append(row);});
        }
        ...
        function updatePagination() {
            var allRows = $('#escalationTable tbody tr');
        ...
        $('#nextPage').on('click', function() {var totalRows = $('#escalationTable tbody tr').length; const totalPages = Math.ceil(totalRows / itemsPerPage); if (currentPage < totalPages) {currentPage++; updatePagination();}});
    });
</script>
