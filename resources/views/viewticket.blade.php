...
<div class="col-lg-9">
  <div class="row">
    <div class="col-md-12 mb-lg-0 mb-4">
      <div class="card h-100 mb-6 shadow-lg" style="border-radius: 10px; border: 1px solid #e4e4e4;">
    ...
    <div class="col-md-12 mb-lg-0 mb-3">
      <div class="card mt-4 shadow-lg" style="border-radius: 19px; border: 1px solid #e4e4e4;">
        <!-- Toggle Button -->
        ...
        <div class="card shadow-lg border-radius-lg overflow-hidden h-100 p-0">
          ...
          <div class="card-body p-3">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item mt-3 d-flex align-items-start shadow-sm" style="border-radius: 10px; border: 2px solid #e4e4e4; padding: 13px;">
                <!-- Foto Profil -->
...
<div class="col-lg-3 ms-auto">
  <div class="card h-100 shadow-sm" style="max-height: 315px; border-radius: 10px; border: 1px solid #e4e4e4;">
    <div class=" pb-0 p-3">
      <div class="row">
      ...
      <ul class="list-group">
        <div class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
          <div class="d-flex flex-column">
            ...
            <span class="text-xs">
              {{'sp-' . substr(preg_replace('/[^0-9]/', '', $ticket->id), -3) . \Carbon\Carbon::parse($ticket->created_at)->format('dmy') . ($ticket->Jenis_Pengaduan == 0 ? '0' : '1') }}
            </span>
          </div>
        </div>
        <div class="d-flex flex-column">
