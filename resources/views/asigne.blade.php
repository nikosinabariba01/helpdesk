...
@section('pages')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Proceeding</li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Proceeding Ticket</h6>
    </nav>
@endsection
@section('upnav')
    ...
    <div class="col-lg-12 mb-lg-0 mb-4 ">
        <div class="card z-index-2 h-100 d-flex flex-column shadow-lg" style="border: 1px solid #e4e4e4;">
            <div class="card-header pb-0 d-flex align-items-center justify-content-between">
                <h6 class="mb-0">Proceeding ticket</h6>
                <div class="d-flex">
