                ...
                <table class="table align-items-center mb-0" id="TicketTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" style="padding: 10px;">Action Status</th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" style="padding: 10px;">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                <div class="d-flex px-2 py-1">
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <div class="d-flex list-inline">
                                            ...
                                            <li class="text-xs list-inline-item text-secondary" title="Created Date"><i class="fa fa-circle fa-xs text-secondary"></i></i> {{\Carbon\Carbon::parse($teknisidataticket->created_at)->format('d-m-Y H:i');}}</li>
                                        </div>
                                    </div>
                                </div>
                            </td>
